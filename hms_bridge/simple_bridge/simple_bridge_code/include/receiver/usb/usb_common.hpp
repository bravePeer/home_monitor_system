...
struct [[gnu::packet]] usb_setup_packet 
{
...
// Nie musi być spakowany?
struct [[gnu::packet]] usb_descriptor 
{
    uint8_t bLength;
    uint8_t bDescriptorType;
};

struct [[gnu::packet]] usb_device_descriptor 
{
    uint8_t bLength;
    uint8_t bDescriptorType;
    uint16_t bcdUSB;
...
struct [[gnu::packet]] usb_configuration_descriptor 
{
    uint8_t bLength;
    uint8_t bDescriptorType;
...
struct [[gnu::packet]] usb_interface_descriptor 
{
    uint8_t bLength;
    uint8_t bDescriptorType;
...
struct [[gnu::packet]] usb_endpoint_descriptor 
{
    uint8_t bLength;
    uint8_t bDescriptorType;
...
struct [[gnu::packet]] usb_endpoint_descriptor_long 
{
    uint8_t bLength;
    uint8_t bDescriptorType;
    uint8_t bEndpointAddress;
